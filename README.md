...
- Factors Affecting the Number of Prescription Drugs by Longitudinal Regression Analysis (SAS) Supervised by Prof. Chaoxiong (Michelle) Xia (NIU) 👉 [info](https://github.com/therealowen/Prescription-Drugs-Prediction-using-SAS)
- Monthly Milk Production Forecast by Time Series Analysis (R), Supervised by Prof. Lelys Bravo de Guenni (UIUC) 👉 [info](https://github.com/therealowen/Time-Series-Analysis---Milk-Production-Prediction)
...
**III. Web Dev Project:**
- Johns Hopkins Developing Internet Systems and Services Course Projects using **HTML, CSS, JavaScript & SiteGround** for Deployment. 👉 [code](https://github.com/therealowen/Website-Dev-Project)
  ![image](https://github.com/therealowen/therealowen/assets/31581639/0bca4fde-80d0-435d-be8f-a657c70ea0c2)

**IV. LLM:**
- Built a multi-labeled sentiment dataset of physician review in healthcare research.<br>
    👉 code for call OpenAI APIs: [GPT Labeler](https://github.com/therealowen/GPTLabeler)
